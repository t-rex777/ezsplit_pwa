...
import EditExpenseForm, { type EditExpenseFormData } from "./editExpenseForm";

interface IEditExpensePageProps {
  expenseId: string;
}

const EditExpensePage = memo(
  ({ expenseId }: IEditExpensePageProps): JSX.Element => {
    ...
    const {
      ...
      queryFn: async () => await expenseService.getExpense(expenseId),
    });

    // Update expense mutation
    const updateExpenseMutation = useMutation({
      mutationFn: (params: Partial<UpdateExpenseRequest>) =>
        expenseService.updateExpense(expenseId, { ...params }),
      onSuccess: async () => {
        toast({
          title: "Success!",
...
EditExpensePage.displayName = "EditExpensePage";
